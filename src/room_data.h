...
static const TileInstance room_tiles[] = {
    ...
    {4, 480, 0, 6, 0, 0, 0, 0},
    {6, 480, 800, 6, 10, 0, 0, 0},
    {5, 560, 0, 7, 0, 0, 0, 0},
    {5, 560, 800, 7, 10, 0, 0, 0},
    {6, 640, 0, 8, 0, 0, 0, 0},
    ...
    {5, 1280, 0, 16, 0, 0, 0, 0},
    {5, 1280, 800, 16, 10, 0, 0, 0},
    {6, 1360, 0, 17, 0, 0, 0, 0},
    {6, 1360, 80, 17, 1, 0, 0, 0},
    {5, 1360, 160, 17, 2, 0, 0, 0},
    {4, 1360, 240, 17, 3, 0, 0, 0},
    {6, 1360, 320, 17, 4, 0, 0, 0},
    {5, 1360, 400, 17, 5, 0, 0, 0},
    {4, 1360, 480, 17, 6, 0, 0, 0},
    {6, 1360, 560, 17, 7, 0, 0, 0},
    {5, 1360, 640, 17, 8, 0, 0, 0},
    {4, 1360, 720, 17, 9, 0, 0, 0},
    {4, 1360, 800, 17, 10, 0, 0, 0},
};

#define ROOM_TILE_COUNT 54
